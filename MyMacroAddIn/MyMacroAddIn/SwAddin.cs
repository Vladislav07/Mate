...
{
    /// <summary>
    /// Summary description for MyMacroAddIn.
    /// </summary>
    [Guid("172251E9-B0B7-421E-9623-892FD92F1713"), ComVisible(true)]
    [SwAddin(
        Description = "Manager Mate",
        Title = "ManagerMateAddIn",
        LoadAtStartup = true
        )]
    public class SwAddin : ISwAddin
    {
        ...
        public void AddCommandMgr()
        {
            ...
            string Title = "ManagerAddIn", ToolTip = "ManagerAddIn";
            ...
            icons[0] = iBmp.CreateFileFromResourceBitmap("MyMacroAddIn.toolbar20x.png", thisAssembly);
            icons[1] = iBmp.CreateFileFromResourceBitmap("MyMacroAddIn.toolbar32x.png", thisAssembly);
            icons[2] = iBmp.CreateFileFromResourceBitmap("MyMacroAddIn.toolbar40x.png", thisAssembly);
            icons[3] = iBmp.CreateFileFromResourceBitmap("MyMacroAddIn.toolbar64x.png", thisAssembly);
            icons[4] = iBmp.CreateFileFromResourceBitmap("MyMacroAddIn.toolbar96x.png", thisAssembly);
            icons[5] = iBmp.CreateFileFromResourceBitmap("MyMacroAddIn.toolbar128x.png", thisAssembly);

            mainIcons[0] = iBmp.CreateFileFromResourceBitmap("MyMacroAddIn.mainicon_20.png", thisAssembly);
            mainIcons[1] = iBmp.CreateFileFromResourceBitmap("MyMacroAddIn.mainicon_32.png", thisAssembly);
            mainIcons[2] = iBmp.CreateFileFromResourceBitmap("MyMacroAddIn.mainicon_40.png", thisAssembly);
            mainIcons[3] = iBmp.CreateFileFromResourceBitmap("MyMacroAddIn.mainicon_64.png", thisAssembly);
            mainIcons[4] = iBmp.CreateFileFromResourceBitmap("MyMacroAddIn.mainicon_96.png", thisAssembly);
            mainIcons[5] = iBmp.CreateFileFromResourceBitmap("MyMacroAddIn.mainicon_128.png", thisAssembly);
            ...
            cmdIndex0 = cmdGroup.AddCommandItem2("Add Component", -1, "Add a part and mate", "Add Component", 0, nameof(AddComponent), "", mainItemID1, menuToolbarOption);
            ...
            cmdIndex1 = cmdGroup.AddCommandItem2("Add Component PMP", -1, "Add a part and mate", "Add Component PMP", 2, nameof(ShowPMP), "EnablePMP", mainItemID2, menuToolbarOption);
        ...
        public void AddComponent()
        {
            ...
            string partPath = "C:\\Parts\\washer.sldprt";
            AddComps.AddCompAndMate(partPath);
        }
